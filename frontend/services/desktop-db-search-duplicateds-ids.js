...
const desktopDbSearchDuplicatedIds = async () => {

    // Constructing the URL with parameters
    let url = new URL('http://localhost:3000/services/desktop-db-search-duplicated-ids');
...
export default desktopDbSearchDuplicatedIds;