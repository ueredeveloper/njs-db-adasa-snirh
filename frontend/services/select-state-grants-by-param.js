...
import { querySelectSubterraneasForInsert, querySelectSuperficiaisForInsert } from "../../backend/services/queries";

const selectStateGrantsByParam = async (param) => {
...
export default selectStateGrantsByParam;