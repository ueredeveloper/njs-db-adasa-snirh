const querySelectSuperficiaisForInsert = (ids)=> {
    ...
    CASE
        ...
        THEN 39
        WHEN S.ID_TIPO_FINALIDADE = 36 AND S.SUBFINALIDADE LIKE '%CONST%'
        THEN 54
		WHEN S.ID_TIPO_FINALIDADE = 35 AND S.SUBFINALIDADE LIKE '%PAIS%'
        THEN 49
		WHEN S.ID_TIPO_FINALIDADE = 40 AND S.SUBFINALIDADE LIKE '%MIN%'
        THEN 28
    END AS FOU_TOU_CD,
    CASE 
    ...
    COALESCE(A.NOME, '') AS INT_DS_OPCIONAL
