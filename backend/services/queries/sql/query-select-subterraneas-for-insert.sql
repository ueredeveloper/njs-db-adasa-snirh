        ...
        */
        ...
        '' AS INT_NU_SIAGAS,
		-- formata para remover valores depois da vírgula, 10,80000 para 10,80 
       ...
       --AND A.ID_INTERFERENCIA <2500 --IN (13870, 4357)
	   -- pesquisa por data
	   --AND A.DT_PUBLICACAO > CONVERT(DATETIME, '01/01/2024', 103)
	   --AND C.NOME LIKE '%EDUARDO%'
	   AND A.ID_INTERFERENCIA  = 12344--4254--14825
		-- Ordenar pela ordem de ids buscadas que é a ordem de proximidade do ponto
		--ORDER  BY CHARINDEX(CAST(A.ID_INTERFERENCIA AS VARCHAR), '3132')
		--AND C.NOME LIKE '%JUVENCINA%'
