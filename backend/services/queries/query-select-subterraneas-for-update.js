const querySelectSubterraneasForUpdate = (ids)=> {
	...
	-- lista de ddds do brasil
		...
		CASE 
            ...
            THEN 5	
            WHEN S.ID_TIPO_FINALIDADE = 11 AND (SUBFINALIDADE NOT LIKE '%LAVAG%' AND SUBFINALIDADE NOT LIKE '%LAVANDERIA%')
		...
		'' OTO_TOU_CD,	
		CASE
			WHEN S.ID_TIPO_FINALIDADE IN (11, 5, 29) AND S.SUBFINALIDADE LIKE '%LAVAGEM DE VE%' --LAVAGEM DE VEÍCULOS OU VEICULOS
            THEN 21
			WHEN S.ID_TIPO_FINALIDADE IN (11, 5, 29) AND S.SUBFINALIDADE LIKE '%LAVANDERIA%'
            THEN 44
            ...
            THEN 39 
			WHEN S.ID_TIPO_FINALIDADE IN (32, 36, 37) AND S.SUBFINALIDADE LIKE '%CONST%'
            THEN 54
			WHEN S.ID_TIPO_FINALIDADE IN (10,39) AND S.SUBFINALIDADE LIKE '%PAIS%'
            THEN 49
			WHEN S.ID_TIPO_FINALIDADE IN (40,41) AND S.SUBFINALIDADE LIKE '%MIN%'
            THEN 28
            ELSE 53  -- Default: Outro
        END AS OTO_CD,	
		'' OTO_NM_OUTROUSO,	
		'' OTO_DS_OUTROUSO,
		'' HTE_CD,	
